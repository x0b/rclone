...
func ListFn(f fs.Fs, fn func(fs.Object)) error {
	return walk.ListR(f, "", false, fs.Config.MaxDepth, func(entries fs.DirEntries) error {
...
func ListDir(f fs.Fs, w io.Writer) error {
	return walk.ListR(f, "", false, ConfigMaxDepth(false), func(entries fs.DirEntries) error {
...
func listToChan(f fs.Fs, dir string) fs.ObjectsChan {
	...
	go func() {
		defer close(o)
		err := walk.ListR(f, dir, true, fs.Config.MaxDepth, func(entries fs.DirEntries) error {
